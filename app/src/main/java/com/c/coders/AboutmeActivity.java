...
public class AboutmeActivity extends AppCompatActivity {
	...
	public void onStart() {
		...
		if (f.getString("a", "").equals("1")) {
			android.graphics.drawable.GradientDrawable gd = new android.graphics.drawable.GradientDrawable(); gd.setColor(Color.parseColor("#AB47BC")); gd.setCornerRadius(10); 
